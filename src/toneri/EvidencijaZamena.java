 ...
 * @author Milos Jelic
 */
public class EvidencijaZamena extends javax.swing.JFrame {

    /**
     * Creates new form EvidencijaZamena
     */
    public EvidencijaZamena() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Toner", "Štampač", "Lokacija", "Izvršio"
            }
        ));
        ...
        jLabel1.setText("Evidencija Zamena");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EvidencijaZamena.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EvidencijaZamena().setVisible(true);
            }
        });
    }
